        ...
        Problem.prototype.renderProgressState = function() {
            ...
            if (curScore === undefined || totalScore === undefined) {
                ...
                if (graded === 'True' && totalScore !== 0) {
                    ...
                    progressTemplate = ngettext(
                        // This comment needs to be on one line to be properly scraped for the translators.
                        // Translators: %(earned)s is the number of points earned. %(possible)s is the total number of
                        // points (examples: 0/1, 1/1, 2/3, 5/10). The total number of points will always be at least 1.
                        // We pluralize based on the total number of points (example: 0/1 point; 1/2 points);
